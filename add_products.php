...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($imageTmp, $uploadPath)) {
        $stmt = $conn->prepare("INSERT INTO products (productName, productDescription, productPrice, productCategory, productImage) VALUES (?, ?, ?, ?, ?)");
        ...
        <div class="col-12 col-md-3 col-lg-2 bg-light vh-50 vh-md-100 d-flex flex-column p-3">
            ...
            <div class="collapse d-md-block bg-light" id="sidebarMenu">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="add_products.php">Product Entry</a>
                    </li>
                    <li class="nav-item">
